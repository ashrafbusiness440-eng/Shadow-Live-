...
class NavigationService {
  ...
  Future<void> navigateToProfile({String? userId}) async {
    try {
      ...
      if (userId != null) {
        await router.pushNamed('profile', queryParameters: {'userId': userId});
      } else {
  ...
  Future<void> navigateToRoom({
    ...
    try {
      ...
      await router.pushNamed(
        ...
        queryParameters: {'isHost': isHost.toString()},
      );
    } catch (e) {
  ...
  Future<void> navigateToError(String errorCode) async {
    try {
      ...
      await router.pushNamed('error', queryParameters: {'code': errorCode});
    } catch (e) {
