                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: saving || idSaving
                            ? null
                            : () async {
                                final requested =
                                    publicIdController.text.trim();
                                final current =
                                    (_roomArguments['publicId'] ?? '')
                                        .toString();
                                if (!RegExp(r'^\d{6}                    TextField(
          ...
          style: const TextStyle(
            ...
            fontSize: 11,
                                ...
                                try {
                                  ...
                                  publicIdController.text = changed;
                                  if (sheetContext.mounted) {
                                    ScaffoldMessenger.of(sheetContext)
                                        .showSnackBar(
                                      const SnackBar(
                        ...
                        label: const Text('تغيير Room ID'),
                      ),
                    ),
