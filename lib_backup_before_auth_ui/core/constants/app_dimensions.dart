...
class AppDimensions {
  ...
  static const double cardBorderRadius = radiusM;
  static const double inputBorderRadius = radiusM;
  static const double buttonBorderRadius = radiusM;

  static const double inputHorizontalPadding = paddingM;
  static const double inputVerticalPadding = paddingS;
  static const double buttonHorizontalPadding = paddingL;
  static const double buttonVerticalPadding = paddingM;

  static const double displayLargeFontSize = fontHero;
  static const double displayMediumFontSize = fontXXL;
  static const double displaySmallFontSize = fontXL;

  static const double headlineLargeFontSize = fontXL;
  static const double headlineMediumFontSize = fontL;
  static const double headlineSmallFontSize = fontM;

  static const double titleLargeFontSize = fontL;
  static const double titleMediumFontSize = fontM;
  static const double titleSmallFontSize = fontS;

  static const double bodyLargeFontSize = fontM;
  static const double bodyMediumFontSize = fontS;
