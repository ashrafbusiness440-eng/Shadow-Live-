...
class RoomListUpdated extends RoomEvent {
...
class RoomBloc extends Bloc<RoomEvent, RoomState> {
  ...
  RoomBloc(this._firebaseService, this._agoraService) : super(RoomInitial()) {
    ...
    on<RoomListUpdated>((event, emit) {
      emit(RoomListLoaded(event.rooms));
    });
  ...
  Future<void> _onLoadRoomList(
    ...
    _roomSubscription = _firebaseService.getRooms().listen(
      (snapshot) {
